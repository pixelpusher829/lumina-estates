      ...
      <div className="bg-white rounded-3xl overflow-hidden border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 h-full flex flex-col">
        ...
        <div className="p-6 flex flex-col flex-grow">
          <div className="flex items-start justify-between mb-2">
            ...
            <ArrowUpRight size={20} className="text-slate-300 group-hover:text-primary-600 transition-colors" />
          </div>
          ...
          <div className="flex items-center justify-between text-slate-600 mt-auto">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-semibold">{property.specs.beds} <span className="text-slate-400 font-normal text-xs">Beds</span></span>
            </div>
            <div className="flex items-center gap-2">
              <div className="p-1.5 bg-slate-50 rounded-lg text-primary-600">
                <Bath size={16} />
              </div>
              <span className="text-sm font-semibold">{property.specs.baths} <span className="text-slate-400 font-normal text-xs">Baths</span></span>
            </div>
            <div className="flex items-center gap-2">
              <div className="p-1.5 bg-slate-50 rounded-lg text-primary-600">
                <Move size={16} />
              </div>
              <span className="text-sm font-semibold">{property.specs.sqft} <span className="text-slate-400 font-normal text-xs">sqft</span></span>
            </div>
          </div>
        </div>
      </div>
